...
- Solution
    - You are using an out-dated API. Please check the [new API with sample code](https://github.com/Mate1/cordova-facebook-plugin/README.md) and sample projects in `platforms/ios` and `platforms/android`.
